    ...
    protected String doInBackground(Object... params) {
        try {
            if (params[0].equals("alert")) {
                ...
                return HTTPHandler.sendPost("http://172.19.157.148:3000/alert", postDataParams);
            }
            else if(params[0].equals("GET")){
                //GET Request
                return data = HTTPHandler.sendGet("http://172.19.157.148:3000/infrastructure");
            }
            else {
                // POST Request for all other type of reports
                JSONObject postDataParams = putInJSON(params);
                return HTTPHandler.sendPost("http://172.19.157.148:3000/"+params[0], postDataParams);
            }
        } catch (Exception e) {
